        ...
        <div class="row">
            ...
            <div class="col s12 margin-top-10 margin-bottom-10">
                <div class="center-align">
                    <a class="light-blue lighten-2 waves-effect waves-light btn-large"><i class="material-icons right">input</i>agregar nuevo</a>
                </div>
            </div>
            <div class="col s12">
                <ul class="collection">
                        ...
                        <p class="left-align"><a class="modal-trigger link" href="#modal1">Ver perfil completo</a></p>
                          ...
                          <div id="modal1" class="modal modal-fixed-footer">
                            <div class="modal-content center-align">
                              ...
                              <h5>supersayayin</h5>
                              <div class="center-align">
                                  <img src="https://31.media.tumblr.com/avatar_bdbe42ad80b3_128.png" alt="">
                              </div>
                            </div>
